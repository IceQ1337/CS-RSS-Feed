...
from include.utils import LANGUAGE_MAP, create_chrome_driver, fetch_page_content, get_date_format, cleanup_text_description, get_feed_file_path, is_feed_up_to_date, update_rss_feed
...
for language_name, (language_code, language_locale) in LANGUAGE_MAP.items():
    ...
    html_content = fetch_page_content(driver, url, 'div[class^="blogoverviewpage_SubEntries"]')
    ...
    for capsule in capsules:
        ...
        news_html_content = fetch_page_content(driver, unique_url, 'div[class^="blogentrypage_BlogEntryPage"]')
